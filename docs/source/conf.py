#
# Sphinx configuration for aiida-bigdft-new
#
...
release = aiida_bigdft_new.__version__
...
html_title = f"aiida-bigdft-new v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-bigdft-new.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "aiida_bigdft_new")
